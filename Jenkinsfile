                    ...
                    'indi-amd64': {
                        script {
                            def build = build job: 'amd64-indi', parameters: [
                                persistentString(name: 'BRANCH', value: "${params.INDI_BRANCH}"),
                                persistentString(name: 'TAG', value: "${params.INDI_TAG}"),
                                persistentString(name: 'BRANCH3P', value: "${params.INDI3P_BRANCH}"),
                                persistentString(name: 'TAG3P', value: "${params.INDI3P_TAG}")]
                    ...
                    'stellarsolver-amd64': {
                        script {
                            def build = build job: 'amd64-stellarsolver', parameters: [
                                persistentString(name: 'BRANCH', value: "${params.STSLV_BRANCH}"),
                                persistentString(name: 'TAG', value: "${params.STSLV_TAG}")]
            ...
            steps {
                parallel(
                    'kstars-amd64': {
                        build job: 'amd64',
                        parameters: [
                            persistentString(name: 'BRANCH', value: "${params.KSTARS_BRANCH}"),
                            persistentString(name: 'TAG', value: "${params.KSTARS_TAG}"),
                            persistentString(name: 'INDI_CORE_BUILD', value: "${INDI_BUILD_AMD64}"),
                            persistentString(name: 'STELLARSOLVER_BUILD', value: "${STSLV_BUILD_AMD64}")
                        ]
                    },
                    ...
                    'phd2-amd64': {
                        ...
                        parameters: [
                            persistentString(name: 'BRANCH', value: "${params.PHD2_BRANCH}"),
                            persistentString(name: 'TAG', value: "${params.PHD2_TAG}")
                        ]
                    },
                    'phd2-i386': {
                        build job: 'i386-phd2',
