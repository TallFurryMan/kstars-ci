pipeline {
  ...
  parameters {
    ...
    buildSelector(name: 'INDI_CORE_BUILD', defaultSelector: latestSuccessfulBuild(), description: 'The build to use for INDI Core, empty for last saved build.')
    buildSelector(name: 'STELLARSOLVER_BUILD', defaultSelector: latestSuccessfulBuild(), description: 'The build to use for StellarSolver, empty for last saved build.')
  }
