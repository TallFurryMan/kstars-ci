pipeline {
  ...
  parameters {
    ...
    buildSelector(name: 'STELLARSOLVER_BUILD', defaultSelector: latestSuccessfulBuild(), description: 'The build to use for StellarSolver, empty for last successful build.')
  }
